...
#define CREATE_SAMPLE_TABLE "CREATE TABLE test_table2(col1 INT,\
                                                 col2 VARCHAR(40),\
                                                 col3 SMALLINT,\
                                                 col4 TIMESTAMP)"
#define INSERT_SAMPLE "INSERT INTO test_table2(col1,col2,col3) VALUES(?,?,?)"
...
///////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////
	int_data= 222;
	strncpy(str_data, "hoho haha xixi", STRING_SIZE);
	str_length= strlen(str_data);
	small_data= 1000;         /* smallint */
	is_null= 1;               /* reset */
