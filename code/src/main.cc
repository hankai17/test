...
void test()
{
    ...
    //DoBussiness(new ip138_spider_ip("1.0.8.0","1.0.15.255"));
    spider_ip* s1 = new tb_spider_ip("1.0.8.0","1.0.15.255");
    std::thread t1(DoBussiness,s1);

    spider_ip* s2 = new ipcn_spider_ip("2.0.8.0","2.0.15.255");
    std::thread t2(DoBussiness,s2);

    spider_ip* s3 = new ip138_spider_ip("100.0.8.0","100.0.15.255");
