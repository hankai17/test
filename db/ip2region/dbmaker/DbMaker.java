...
public class DbMaker
{
        ...
        throws IOException
    {
        if(globalRegionFile != null)
        {
            ...
            BufferedReader bufferedreader = new BufferedReader(new FileReader(globalRegionFile)); //区号文件
            Object obj = null;
            do
            {
                String s1;
                if((s1 = bufferedreader.readLine()) == null)
                    break;
                String as[] = s1.split(",");
                if(as.length == 5)     //国家                  行号
                    globalRegionMap.put(as[2], Integer.valueOf(as[0]));
            } while(true);
            bufferedreader.close();
            System.out.println("|--[Ok]");
        }
        BufferedReader bufferedreader1 = new BufferedReader(new FileReader(ipSrcFile)); //ip资源文件
        ...
        Ufkdil.writeIntLong(abyte0, 0, l1);
        ...
        Prandomaccessfile.write(s6.getBytes());
        System.out.println("|--[Ok]");
    ...
    public int getCityId(String s)
    {
        ...
        for(int i = 3; i >= 0; i--)
            ...
            {
                String s1;
                if(i == 3 && as[i].indexOf("\u7701\u76F4\u8F96\u53BF\u7EA7") > -1) //省直辖县级
