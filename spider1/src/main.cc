...
void ip138()
{
    ...
    */
    ...
    //std::thread t1(DoBussiness,new ip138_spider_ip("60.190.0.0","100.0.0.0")); 
    //std::thread t1(DoBussiness,new ip138_spider_ip("1.31.100.0","1.32.0.0")); 
        //{ 222,240,0,0 , 222,250,0,0 }
    //std::thread t1(DoBussiness,new ip138_spider_ip("202.194.160.0","202.194.176.0")); 
        //{ 203,93,0,0 , 203,94,32,0 },
    //std::thread t1(DoBussiness,new ip138_spider_ip("203.93.160.0","203.93.166.0")); 
    //std::thread t1(DoBussiness,new ip138_spider_ip("203.187.160.0","203.187.166.0")); 
    //std::thread t1(DoBussiness,new ip138_spider_ip("202.0.160.0","202.0.180.0")); 
...
void ipcn()
{
    ...
    */
    //std::thread t1(DoBussiness,new ipcn_spider_ip("111.63.0.0","111.63.128.0")); 
    std::thread t1(DoBussiness,new ipcn_spider_ip("111.63.0.0","111.63.0.0")); 
    t1.join();
    return;
}
