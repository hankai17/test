...
struct conf_value{
    ...
    char path_keywords_filter_list[60];
    char dns_thread_num[8];
    char http_thread_num[8];
    char insert_name[20];
};
...
extern rule *keywords_filter;
extern rule *server_ip;
...
extern int now_count_server_ip,max_count_server_ip;
extern int now_count_keywords_filter,max_count_keywords_filter;
...
extern int file_compare_http_host(const char *http_host , const int handle_method , const char *requset_line);
...
//extern int read_keywords_filter_list(char *filename);
