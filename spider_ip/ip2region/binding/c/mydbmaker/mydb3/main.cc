...
int search_ip(char* buffer, int file_size, std::string&& ip1, std::string& result)
//int search_ip(char* buffer, int file_size, auto&& ip2, std::string& result)
{
    //std::string ip1 = ip2;
    if(ip1.length() == 0)
    {
...
int main(int argc, char* argv[])
{
    ...
    std::string result;
    if(search_ip(buf,file_size,"103.8.0.0",result))
    //if(search_ip(buf,file_size,"10.8.0.0",result))
    {
