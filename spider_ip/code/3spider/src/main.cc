...
void test()
{
    ...
    //DoBussiness(new ip138_spider_ip("1.15.253.0","1.16.0.0"));

    DoBussiness(new ip138_spider_ip("58.87.64.0","58.87.128.0"));
    /*
    for(int i = 0; i < 100; i++)
    {
        ...
        //DoBussiness(new tb_spider_ip(ip_b[i],ip_e[i]));
    }
    */
    //DoBussiness(new ip138_spider_ip(ip_b[0],ip_e[0]));
    //DoBussiness(new tb_spider_ip(ip_b[0],ip_e[0]));
    //DoBussiness(new tb_spider_ip("1.12.254.0",ip_e[0]));

/*
    spider_ip* s1 = new tb_spider_ip("1.0.8.0","1.0.15.255");
    std::thread t1(DoBussiness,s1);

    spider_ip* s2 = new ip138_spider_ip("1.0.8.0","1.0.15.255");
