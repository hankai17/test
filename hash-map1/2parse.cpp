...
__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp> str_white_domain_hash;
__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp> str_white_head_hash;
__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp> str_white_rear_hash;
/*********/	
...
int dns_conf::parse_white_conf()
{
	...
	while (cfilestream.get(ch)) {
        ...
        if( domains_flag == 1)//解析域名小组
        {
			...
			if (ref_num == 2)
			{
				...
				if (flag == '0')
				{
					...
					str_white_domain_hash.insert(__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::value_type(tmp,str_p));					
					//delete []tmp;
				}
				else if (flag == '1')
				{
          ...
          str_white_head_hash.insert(__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::value_type(tmp,str_p));					
					//delete []tmp;
				}
				else if (flag == '2')
				{	
        ...
        str_white_rear_hash.insert(__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::value_type(tmp,str_p));					
				//delete []tmp;
				}
...
std::cout<<"************************"<<std::endl;
	...
	if( ( iter = str_white_rear_hash.find(dm)) == str_white_rear_hash.end() ) {
