...
std::vector<std::vector<char*>*> servers2;

std::vector<char**> servers1;
std::vector<char*> ip1;
std::vector<char*> domain1;
...
__gnu_cxx::hash_map<char*, std::vector<std::string>*,__gnu_cxx::hash<char*>,hm_strcmp1> domain_hash2;
__gnu_cxx::hash_map<char*, std::vector<std::string>*,__gnu_cxx::hash<char*>,hm_strcmp1> head_hash2;
__gnu_cxx::hash_map<char*, std::vector<std::string>*,__gnu_cxx::hash<char*>,hm_strcmp1> rear_hash2;

__gnu_cxx::hash_map<char*, std::vector<char*>*,__gnu_cxx::hash<char*>,hm_strcmp1> domain_hash3;
__gnu_cxx::hash_map<char*, std::vector<char*>*,__gnu_cxx::hash<char*>,hm_strcmp1> head_hash3;
__gnu_cxx::hash_map<char*, std::vector<char*>*,__gnu_cxx::hash<char*>,hm_strcmp1> rear_hash3;

__gnu_cxx::hash_map<char*, char**,__gnu_cxx::hash<char*>,hm_strcmp1> domain_hash1;
__gnu_cxx::hash_map<char*, char**,__gnu_cxx::hash<char*>,hm_strcmp1> head_hash1;
__gnu_cxx::hash_map<char*, char**,__gnu_cxx::hash<char*>,hm_strcmp1> rear_hash1;
...
void dns_conf::open_conf_file() {
	...
	try
	{
		cfilestream.open(cfilename.c_str());
...
int dns_conf::parse_white_conf()
{
	...
	while (cfilestream.get(ch)) {
        ...
        if( domains_flag == 1)//解析域名小组
        {
			...
			if (ref_num == 2)
			{
				...
				if (flag == '0')
				{
					...
					//__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp> str_domain_hash;
					str_domain_hash.insert(__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::value_type(tmp,str_p));					
					//delete []tmp;
				}
				else if (flag == '1')
				{
          ...
          str_head_hash.insert(__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::value_type(tmp,str_p));					
					//delete []tmp;
				}
				else if (flag == '2')
				{	
        ...
        std::cout<<"rear_hash:"<<tmp<<std::endl;
        str_rear_hash.insert(__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::value_type(tmp,str_p));					
				//delete []tmp;
				}
...
std::cout<<"************************"<<std::endl;
	...
	//char dm[] = "www.baidu.";
	char dm[] = "login.";
	__gnu_cxx::hash_map<char*, std::vector<icr_str_t*>*,str_hash,hm_strcmp>::iterator iter;
	if( ( iter = str_rear_hash.find(dm)) == str_rear_hash.end() ) {
