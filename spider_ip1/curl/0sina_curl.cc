...
char curl_ics(std::string &chip)
{
    ...
    memcpy(url, "http://int.dpool.sina.com.cn/iplookup/iplookup.php?ip=182.135.131.37", strlen("http://int.dpool.sina.com.cn/iplookup/iplookup.php?ip=182.135.131.37"));
    //结果是 1-1-1 中国 北京 北京 
